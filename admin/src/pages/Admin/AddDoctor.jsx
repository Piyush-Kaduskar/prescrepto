...
const AddDoctor = () => {
  ...
  return (
    <form  onSubmit={onSubmitHandler} className='m-5 w-full' action="">
      ...
      <div className='bg-white px-8 py-8 border border-gray-200 rounded max-w-4xl max-h-[80vh] overflow-y-scroll' >
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div>
              <p className='flex-1 flex gap-1 flex-col '>Address:</p>
        ...
        <div>
          ...
          <textarea  onChange={(e)=>setAbout(e.target.value)} value={about}  className='w-full border-gray-200 px-4 pt-2 border border-rounded' placeholder='write about doctor' rows={5} required />
        </div>
